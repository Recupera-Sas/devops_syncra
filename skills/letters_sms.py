...
def generate_sms_message_column(data_frame):
    ...
    data_frame = data_frame.withColumn("SMS_6",
        ...
        .otherwise(concat(lit("El no pago oportuno de tu factura del Equipo Claro Ref "),col("Referencia"), lit (" "), col("Form_Moneda"), \
                          lit(" genera la inhabilitacion de tus dispositivo. Inf __WHATSAPP__ Si pagaste omite msj. AplicaTyC(15)"))))
    ...
    data_frame = data_frame.withColumn("SMS_12",
        ...
        concat(lit("Aun no vemos reflejado el pago de tu factura en mora Claro "),col("PRODUCTO"),lit(" Ref "),col("Referencia"), \
               lit(" por "),col("Form_Moneda"),lit(" Recuerda que de no pagar hoy seras reportado negativamente en centrales de riesgo. Paga aqui bit.ly/3aULNAj. Si pagaste omite msj. AplicaTyC(15)")))
    ...
    data_frame = data_frame.withColumn("SMS_13",
        ...
        concat(lit("Cuida tu historial Crediticio paga hoy la factura vencida Claro "),col("PRODUCTO"),lit(" Ref "),col("Referencia"), \
               lit(" "), col("Form_Moneda"),lit(" evita reportes negativos en Centrales. Si pagaste omite msj. AplicaTyC(15)")))
    ...
    data_frame = data_frame.withColumn("SMS_16",
        ...
        ### ORIGEN RR - BSCS - SGA 
        concat(lit("Reactiva nuevamente los servicios Claro "),col("PRODUCTO"),lit(". Paga hoy con Ref "),col("Referencia"), \
               lit(" por "),col("Form_Moneda"),lit(" evita cobros adicionales. Inf __WHATSAPP__ Si pagaste omite msj. AplicaTyC(15)")))

        ### ORIGEN ASCARD
        .otherwise(concat(lit("Reactiva nuevamente tu Equipo Claro. Paga hoy con Ref "),col("Referencia"), \
                          lit(" por "),col("Form_Moneda"),lit(" evita cobros adicionales. Inf __WHATSAPP__ Si pagaste omite msj. AplicaTyC(15)"))))
    ...
    data_frame = data_frame.withColumn("SMS_19",
        ...
        ### ORIGEN ASCARD
        .otherwise(concat(lit("La deuda de tu Equipo Financiado Claro se encuentra en etapa prejuridica Paga con Ref "), \
                          col("Referencia"),lit(" por "),col("Form_Moneda"),lit(" Inf __WHATSAPP__ Si pagaste omite msj AplicaTyC(15)"))))
    ...
    data_frame = data_frame.withColumn("SMS_22",
        when((col("CRM") == "BSCS") | (col("CRM") == "RR") | (col("CRM") == "SGA"), 
        
        ### ORIGEN RR - BSCS - SGA 
        concat(lit("A tiempo la vida es mas facil Paga hoy tu factura vencida "),col("PRODUCTO"),lit(" Claro Ref "),col("Referencia"),\
               lit(" por "),col("Form_Moneda"),lit(" Ingresa bit.ly/3aULNA Si pagaste omite msj. AplicaTyC(15)")))

        ### ORIGEN ASCARD
        .otherwise(concat(lit("A tiempo la vida es mas facil Paga hoy tu factura vencida Equipo Claro Ref "),col("Referencia"),\
               lit(" por "),col("Form_Moneda"),lit(" Ingresa bit.ly/3aULNA Si pagaste omite msj. AplicaTyC(15)"))))
    
    data_frame = data_frame.withColumn("SMS_23",
        concat(lit("Termina el mes estando al dia en factura "),col("PRODUCTO"),lit(" Claro Ref "),col("Referencia"), lit(" por "),\
               col("Form_Moneda"),lit(" evita reportes negativos. Inf __WHATSAPP__ Si pagaste omite msj(15)")))

        

    ####Filter of Brands and Messages
    SMS_1_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_2_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_3_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_4_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_5_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_6_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_7_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_8_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_9_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_10_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_11_Filter = (col("DCTO") != "0") | (col("DCTO") != "0%")
    SMS_12_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_13_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_14_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_15_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_16_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_17_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_18_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_19_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_20_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_21_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")
    SMS_22_Filter = (col("Edad_Mora") == "0") | (col("Edad_Mora") == "30")

    data_frame = data_frame.withColumn("SMS_11", when(SMS_11_Filter, col("SMS_11"))\
                                      .otherwise(lit("N/A")))
